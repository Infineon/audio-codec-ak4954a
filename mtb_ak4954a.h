 ...
 */
#define AK4954A_SIG_SEL1_MGAIN_0dB           (0x04) /**< 0 dB gain */
#define AK4954A_SIG_SEL1_MGAIN_6dB           (0x00) /**< 6 dB gain */
#define AK4954A_SIG_SEL1_MGAIN_13dB          (0x01) /**< 13 dB gain */
#define AK4954A_SIG_SEL1_MGAIN_20dB          (0x02) /**< 20 dB gain */
#define AK4954A_SIG_SEL1_MGAIN_26dB          (0x03) /**< 26 dB gain */
 ...
 */
#define AK4954A_SIG_SEL2_RIN1                (0x00) /**< RIN1 */
#define AK4954A_SIG_SEL2_RIN2                (0x01) /**< RIN2 */
#define AK4954A_SIG_SEL2_RIN3                (0x02) /**< RIN3 */
 ...
 */
#define AK4954A_SIG_SEL2_LIN1                (0x00) /**< LIN1 */
#define AK4954A_SIG_SEL2_LIN2                (0x04) /**< LIN2 */
#define AK4954A_SIG_SEL2_LIN3                (0x08) /**< LIN3 */
 ...
 */
#define AK4954A_SIG_SEL2_SLG_0db             (0x00) /**< 0 dB gain */
#define AK4954A_SIG_SEL2_SLG_2db             (0x40) /**< 2 dB gain */
#define AK4954A_SIG_SEL2_SLG_4db             (0x80) /**< 4 dB gain */
#define AK4954A_SIG_SEL2_SLG_6db             (0xC0) /**< 6 dB gain */
 ...
 */
#define AK4954A_SIG_SEL3_PTS_1X              (0x00) /**< 1X time */
#define AK4954A_SIG_SEL3_PTS_2X              (0x04) /**< 2X time */
#define AK4954A_SIG_SEL3_PTS_4X              (0x08) /**< 4X time */
#define AK4954A_SIG_SEL3_PTS_8X              (0x0C) /**< 8X time */
 ...
 */
#define AK4954A_MODE_CTRL1_BCK0_32fs         (0x00) /**< 32 fs */
#define AK4954A_MODE_CTRL1_BCK0_64fs         (0x08) /**< 64 fs */
 ...
 */
#define AK4954A_MODE_CTRL2_CM_256fs          (0x00) /**< 256 fs */
#define AK4954A_MODE_CTRL2_CM_384fs          (0x40) /**< 384 fs */
#define AK4954A_MODE_CTRL2_CM_512fs          (0x80) /**< 512 fs */
#define AK4954A_MODE_CTRL2_CM_1024fs         (0xC0) /**< 1024 fs */
 ...
 */
#define AK4954A_DIG_MIC_PMDM_OFF             (0x00) /**< Off */
#define AK4954A_DIG_MIC_PMDM_RIGHT           (0x10) /**< Right */
#define AK4954A_DIG_MIC_PMDM_LEFT            (0x20) /**< Left */
#define AK4954A_DIG_MIC_PMDM_STEREO          (0x30) /**< Stereo */
 ...
 */
#define AK4954A_TMR_SEL_DVTM_144fs           (0x00) /**< 144 fs */
#define AK4954A_TMR_SEL_DVTM_288fs           (0x01) /**< 288 fs */
#define AK4954A_TMR_SEL_DVTM_576fs           (0x02) /**< 576 fs */
 ...
 */
#define AK4954A_TMR_SEL_OVTM_16fs            (0x00) /**< 16 fs */
#define AK4954A_TMR_SEL_OVTM_64fs            (0x04) /**< 64 fs */
#define AK4954A_TMR_SEL_OVTM_128fs           (0x08) /**< 128 fs */
#define AK4954A_TMR_SEL_OVTM_256fs           (0x0C) /**< 256 fs */
 ...
 */
#define AK4954A_TMR_SEL_ADRST_2115fs         (0x00) /**< 2115 fs */
#define AK4954A_TMR_SEL_ADRST_4227fs         (0x40) /**< 4227 fs */
#define AK4954A_TMR_SEL_ADRST_267fs          (0x80) /**< 267 fs */
#define AK4954A_TMR_SEL_ADRST_1059fs         (0xC0) /**< 1059 fs */
 ...
 */
#define AK4954A_ALC_TMR_SEL_RFST_0p0032db    (0x00) /**< 0p0032db */
#define AK4954A_ALC_TMR_SEL_RFST_0p0042db    (0x01) /**< 0p0042db */
#define AK4954A_ALC_TMR_SEL_RFST_0p0064db    (0x02) /**< 0p0064db */
#define AK4954A_ALC_TMR_SEL_RFST_0p0127db    (0x03) /**< 0p00127db */
 ...
 */
#define AK4954A_ALC_TMR_SEL_WTM_128fs        (0x00) /**< 128 fs */
#define AK4954A_ALC_TMR_SEL_WTM_256fs        (0x04) /**< 256 fs */
#define AK4954A_ALC_TMR_SEL_WTM_512fs        (0x08) /**< 512 fs */
#define AK4954A_ALC_TMR_SEL_WTM_1024fs       (0x0C) /**< 1024 fs */
 ...
 */
#define AK4954A_ALC_TMR_SEL_IVTM_236fs       (0x00) /**< 236 fs */
#define AK4954A_ALC_TMR_SEL_IVTM_944fs       (0x40) /**< 944 fs */
#define AK4954A_ALC_TMR_SEL_IVTM_1888fs      (0x80) /**< 1888 fs */
#define AK4954A_ALC_TMR_SEL_IVTM_3776fs      (0xC0) /**< 3776 fs */
 ...
 */
#define AK4954A_BEEP_FREQ_BPFR_4000Hz        (0x01) /**< 4000 Hz */
#define AK4954A_BEEP_FREQ_BPFR_2000Hz        (0x02) /**< 2000 Hz */
#define AK4954A_BEEP_FREQ_BPFR_1300Hz        (0x03) /**< 1300 Hz */
#define AK4954A_BEEP_FREQ_BPFR_800Hz         (0x04) /**< 800 Hz */
 ...
 */
#define AK4954A_DIG_FLTR_SEL2_GN_0db         (0x00) /**< 0 db */
#define AK4954A_DIG_FLTR_SEL2_GN_12db        (0x40) /**< 12 db */
#define AK4954A_DIG_FLTR_SEL2_GN_24db        (0x80) /**< 24 db */
 ...
 * DRC Setting Enable
 */
#define AK4954A_DRC_MODE_CTRL_DRCC_DISABLE   (0x00) /**< Disable */
#define AK4954A_DRC_MODE_CTRL_DRCC_LOW       (0x01) /**< Low */
#define AK4954A_DRC_MODE_CTRL_DRCC_MIDDLE    (0x02) /**< Middle */
#define AK4954A_DRC_MODE_CTRL_DRCC_HIGH      (0x03) /**< High */
 ...
 */
#define AK4954A_NS_CTRL_DRCM_STEREO          (0x00) /**< Stereo */
#define AK4954A_NS_CTRL_DRCM_LEFT            (0x10) /**< Left */
#define AK4954A_NS_CTRL_DRCM_RIGHT           (0x20) /**< Right */
 ...
 */
#define AK4954A_NS_ON_LEVEL_NSIAF_256fs      (0x00) /**< 256 fs */
#define AK4954A_NS_ON_LEVEL_NSIAF_512fs      (0x40) /**< 512 fs */
#define AK4954A_NS_ON_LEVEL_NSIAF_1024fs     (0x80) /**< 1024 fs */
#define AK4954A_NS_ON_LEVEL_NSIAF_2048fs     (0xC0) /**< 2048 fs */
 ...
 */
#define AK4954A_NS_OFF_LEVEL_NSOAF_4fs       (0x00) /**< 4 fs */
#define AK4954A_NS_OFF_LEVEL_NSOAF_8fs       (0x40) /**< 8 fs */
#define AK4954A_NS_OFF_LEVEL_NSOAF_16fs      (0x80) /**< 16 fs */
#define AK4954A_NS_OFF_LEVEL_NSOAF_32fs      (0xC0) /**< 32 fs */
 ...
 */
#define AK4954A_DVLC_FLTR_SEL_DHHPF_DISABLE  (0x00) /**< Disable */
#define AK4954A_DVLC_FLTR_SEL_DHHPF_1ST      (0x01) /**< 1st */
#define AK4954A_DVLC_FLTR_SEL_DHHPF_2ND      (0x02) /**< 2nd */
 ...
 */
#define AK4954A_DVLC_FLTR_SEL_DMLPF_DISABLE  (0x00) /**< Disable */
#define AK4954A_DVLC_FLTR_SEL_DMLPF_1ST      (0x04) /**< 1st */
#define AK4954A_DVLC_FLTR_SEL_DMLPF_2ND      (0x08) /**< 2nd */
 ...
 */
#define AK4954A_DVLC_FLTR_SEL_DMHPF_DISABLE  (0x00) /**< Disable */
#define AK4954A_DVLC_FLTR_SEL_DMHPF_1ST      (0x10) /**< 1st */
#define AK4954A_DVLC_FLTR_SEL_DMHPF_2ND      (0x20) /**< 2nd */
 ...
 */
#define AK4954A_DVLC_FLTR_SEL_DLLPF_DISABLE  (0x00) /**< Disable */
#define AK4954A_DVLC_FLTR_SEL_DLLPF_1ST      (0x40) /**< 1st */
#define AK4954A_DVLC_FLTR_SEL_DLLPF_2ND      (0x80) /**< 2nd */
 ...
 */
#define AK4954A_DVLC_MODE_CTRL_DAF_256fs     (0x00) /**< 256 fs */
#define AK4954A_DVLC_MODE_CTRL_DAF_384fs     (0x01) /**< 384 fs */
#define AK4954A_DVLC_MODE_CTRL_DAF_512fs     (0x02) /**< 512 fs */
#define AK4954A_DVLC_MODE_CTRL_DAF_1024fs    (0x03) /**< 1024 fs */
 ...
 */
#define AK4954A_DEF_SAMPLING_RATE   AK4954A_MODE_CTRL2_CM_256fs /**< Default sample rate */
#define AK4954A_DEF_DATA_ALIGNMENT  AK4954A_MODE_CTRL1_DIF_32_I2S /**< Default data alignment */
